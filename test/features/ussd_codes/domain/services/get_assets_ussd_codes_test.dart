...
void main() {
  GetAssetsUssdCodes service;
  MockUssdCodesRepository mockUssdCodesRepository;

  setUp(() {
    mockUssdCodesRepository = MockUssdCodesRepository();
    service = GetAssetsUssdCodes(repository: mockUssdCodesRepository);
  });
  ...
  test('Should get ussd code list from repository', () async {
    ...
    // arrange
    when(mockUssdCodesRepository.getAssetsUssdCodes())
    ...
    verify(mockUssdCodesRepository.getAssetsUssdCodes());
