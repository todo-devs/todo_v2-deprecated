...
Future<Database> getDataBase() async {
  final Future<Database> database = openDatabase(
    ...
    join(await getDatabasesPath(), 'micubacel.db'),
    ...
    onCreate: (db, version) {
      ...
      return db.execute(
        "CREATE TABLE users(id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT, phone TEXT, password TEXT, active BOOLEAN DEFAULT 1)",
      );
    },
